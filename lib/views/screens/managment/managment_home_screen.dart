...
class ManagmentHomeScreen extends StatefulWidget {
  ManagmentHomeScreen({Key? key}) : super(key: key);

  @override
  State<ManagmentHomeScreen> createState() => _ManagmentHomeScreenState();
}

class _ManagmentHomeScreenState extends State<ManagmentHomeScreen>
  ...
  String title = "Home";
  Widget currentScreen = ManagmentLogScreen();
      ...
      case 1:
        {
          ...
          setState(() {
            title = AppLocalizations.of(context)!.translate('price_request');
            currentScreen = PriceRequestLogScreen();
          });
          break;
        }
      case 2:
                            ...
                            Tab(
                              ...
                              icon: navigationValue == 1
                                  ? Column(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          "assets/icons/pricing_orange.svg",
                                          width: 36.w,
                                          height: 36.h,
                                        ),
                                        localeState.value.languageCode == 'en'
                                  ...
                                  : Column(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          "assets/icons/Pricing_white.svg",
                                          width: 30.w,
                                          height: 30.h,
                                        ),
                                        localeState.value.languageCode == 'en'
